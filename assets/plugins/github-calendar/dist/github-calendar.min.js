...
!function (e) {
    ...
    return function () {
        ...
        1: [function (e, t) {
            var r = e("github-calendar-parser"), n = e("elly"), a = e("add-subtract-date"), o = e("formatoid"),
                s = "MMM D, YYYY", u = "MMMM D";
            t.exports = function (e, t, i) {
                ...
                var c = function l() {
                    return fetch(i.proxy("https://github.com/" + t)).then(function (e) {
                        ...
                        if (n(".position-relative h2", d).remove(), d.querySelector(".float-left.text-gray").innerHTML = i.summary_text, d.querySelector("include-fragment")) setTimeout(l, 500); else {
                            if (i.responsive === !0) {
                                var f = d.querySelector("svg.js-calendar-graph-svg"), p = f.getAttribute("width"),
            ...
            var r = e("months"), n = e("days"), a = e("fillo"), o = e("parse-it").Parser, s = {
                YYYY: function (e, t) {
            ...
            t.exports = function (e) {
                ...
                return e.split("\n").slice(2).map(function (e) {
                    ...
                    var o = e.match(/fill="(#[a-z0-9]+)"/), s = e.match(/data-date="([0-9\-]+)"/),
                        u = e.match(/data-count="([0-9]+)"/);
                    if (o = o && o[1], s = s && s[1], u = u && +u[1], o) {
                        var i = {fill: o, date: new Date(s), count: u, level: r.indexOf(o)};
            ...
            function r(e, t) {
                var r = 0, n = [];
                if (Array.isArray(e)) for (; r < e.length && t(e[r], r, e) !== !1; ++r) ; else if ("object" === ("undefined" == typeof e ? "undefined" : _typeof(e)) && null !== e) for (n = Object.keys(e); r < n.length && t(e[n[r]], n[r], e) !== !1; ++r) ;
            }
